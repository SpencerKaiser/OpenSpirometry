//
//  ModalTimerPageViewController.m
//  OpenSpirometry
//
...
@interface ModalTimerPageViewController ()
...
@implementation ModalTimerPageViewController
...
- (IBAction)actionButtonPressed:(id)sender {
    if([self.modalTimerPageDelegate respondsToSelector:@selector(userActionTaken)])
    {
        [self.modalTimerPageDelegate userActionTaken];
    } else {
